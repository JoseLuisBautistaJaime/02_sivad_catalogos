...
public class Metal implements CatalogoConfigurable{
     ...
     */
    public Metal abreviatura(String abreviatura) {
        this.abreviatura = abreviatura;
        return this;
    }
     ...
     * @return CondicionPrenda
     */
    public Metal etiqueta(String etiqueta) {
        this.etiqueta = etiqueta;
        return this;
    }
     ...
     *
     * @return Metal objeto concatenado con elementos del catálogo.
     */
    @Override
