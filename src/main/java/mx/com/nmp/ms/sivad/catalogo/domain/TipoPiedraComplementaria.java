...
/**
 * Entidad que representa el catálogo de Tipo Piedra Complementaria
 *
 * @author roramirez
 */

@Entity
@Table(name = "cat_tipo_piedra_complementaria")
@org.hibernate.annotations.Cache(usage = CacheConcurrencyStrategy.NONSTRICT_READ_WRITE)
@JsonIgnoreProperties({"idElemento", "configuracion"})
@EntityListeners(JournalEntityListener.class)
public class TipoPiedraComplementaria implements CatalogoConfigurable {

    private static final long serialVersionUID = -6871961467176678856L;

    /**
     * Constructor.
     */
    public TipoPiedraComplementaria() {
        super();
    }
