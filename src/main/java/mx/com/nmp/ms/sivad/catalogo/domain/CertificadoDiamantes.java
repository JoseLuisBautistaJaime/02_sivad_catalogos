...
/**
 * Entidad que representa el catálogo Certificado Diamantes
 *
 * @author roramirez
 */

@Entity
@Table(name = "cat_certificado_diamantes")
@org.hibernate.annotations.Cache(usage = CacheConcurrencyStrategy.NONSTRICT_READ_WRITE)
@JsonIgnoreProperties({"idElemento", "configuracion"})
@EntityListeners(JournalEntityListener.class)
public class CertificadoDiamantes implements CatalogoConfigurable {

    private static final long serialVersionUID = 7515414404723815344L;

    /**
     * Constructor.
     */
    public CertificadoDiamantes(){super();}
