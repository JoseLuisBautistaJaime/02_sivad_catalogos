...
/**
 * Entidad que representa el catálogo Quilataje Oro.
 *
 * @author ngonzalez
 */
@Entity
...
public class QuilatajeOro implements CatalogoConfigurable {

    private static final long serialVersionUID = -5002190279030644322L;
