...
INSERT INTO CNF_CONFIGURACION_CATALOGO(id, dominio, tipo, valor_default, descripcion) VALUES (2,'Diamantes','MotivoBajaPrestamo','MTA','Catálogo Motivos de Baja de Prestamo');
INSERT INTO CAT_MOTIVO_BAJA_PRESTAMO(abreviatura, etiqueta, id_configuracion) VALUES ('MTA','Motivo A', 2);
INSERT INTO CAT_MOTIVO_BAJA_PRESTAMO(abreviatura, etiqueta, id_configuracion) VALUES ('MTB','Motivo B', 2);
...
INSERT INTO CNF_CONFIGURACION_CATALOGO(id, dominio, tipo, valor_default, descripcion) VALUES (8,'Alhajas','Metal','AU','Catálogo de Metales');
INSERT INTO CAT_METAL(abreviatura, etiqueta, id_configuracion) VALUES ('AU','Oro', 8);
INSERT INTO CAT_METAL(abreviatura, etiqueta, id_configuracion) VALUES ('MT','Metal Precioso', 8);
INSERT INTO CAT_METAL(abreviatura, etiqueta, id_configuracion) VALUES ('OM','Otro Metal', 8);

INSERT INTO CNF_CONFIGURACION_CATALOGO(id, dominio, tipo, valor_default, descripcion) VALUES (9,'Alhajas','CalidadLey','BJ','Catálogo de Calidades Ley');
INSERT INTO CAT_CALIDAD_LEY(abreviatura, etiqueta, id_configuracion) VALUES ('BJ','Baja', 9);
INSERT INTO CAT_CALIDAD_LEY(abreviatura, etiqueta, id_configuracion) VALUES ('MD','Medio', 9);
INSERT INTO CAT_CALIDAD_LEY(abreviatura, etiqueta, id_configuracion) VALUES ('AT','Alto', 9);
INSERT INTO CAT_CALIDAD_LEY(abreviatura, etiqueta, id_configuracion) VALUES ('FN','Fina', 9);
