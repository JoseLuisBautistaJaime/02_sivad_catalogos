...
/**
 * Utilizada por la consola CRaSH para la administración del catálogo Color Oro.
 *
 * @author ngonzalez
 */
@Usage("Administración del catálogo Color Oro")
class colorOro {
    ...
    /**
     * Permite obtener la instancia del servicio ColorOroService.
     *
     * @param context El contexto de la invocación.
     * @return Referencia al servicio de ColorOroService.
     */
    private static ColorOroService getServicio(InvocationContext context) {
        context.attributes['spring.beanfactory'].getBean(ColorOroService)
    }
